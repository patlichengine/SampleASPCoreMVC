...
namespace DemoApp.Entities
{
    public partial class SchoolRecognitionContext : DbContext
    {
        ...
        public virtual DbSet<FacilityItemSetting> FacilityItemSetting { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-IFRMU6GH\\MSSQLSERVER08;Database=SchoolRecognition;User Id=sa;Password=sa;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FacilitySettings>(entity =>
            {
                ...
                entity.HasOne(d => d.FacilityItem)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FacilitySettings_FacilityItemSetting");
